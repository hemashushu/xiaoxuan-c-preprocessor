...
///   e.g., `#include <stdio.h>`.
/// - `module_headers_directories`: Directories to search for module-specific headers.
...
///   otherwise, it will only search in the specified `module_headers_directories`.
pub fn preprocess_source_files(
    source_files: &[&Path],
    system_headers_directories: &[&Path],
    module_headers_directories: &[&Path],
